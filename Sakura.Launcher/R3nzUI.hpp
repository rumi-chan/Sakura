...
namespace SakuraLauncher {
	...
	public:
		...
		void saveSettings()
		{
			...
			auto settingsFolder = Path::Combine(appDataPath, L"Sakura");
			auto settingsFilePath = Path::Combine(settingsFolder, L"Sakura.Launcher");
...
#pragma region Windows Form Designer generated code
		   void InitializeComponent()
		   {
			   ...
			   this->dllStatusGroupBox->Text = L"Sakura Status";
			   // 
			   // clientStatusLabel
			   // 
			   ...
			   this->copyrightLabel->Text = L"Copyright (c) 2023-2024 Sakurasou-Group";
...
#pragma endregion
	...
	private:
		...
		{
			Diagnostics::Process::Start(L"https://github.com/rumi-chan/Sakura");
		}
	private:
